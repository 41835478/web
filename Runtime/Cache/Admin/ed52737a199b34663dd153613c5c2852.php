    ...
    <div class="panel dux-box  active">
        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="label">
                    <label for="sitename">微信AppID：</label>
                </div>
                <div class="field">
                    <input type="text" datatype="*" value="<?php echo ($db_config["AppID"]); ?>" size="60" name="config[AppID]" id="site_subtitle" class="input">
                    <div class="input-note"></div>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                    <label for="sitename">微信AppSecret：</label>
                </div>
                <div class="field">
                    <input type="text" datatype="*" value="<?php echo ($db_config["AppSecret"]); ?>" size="60" name="config[AppSecret]" id="site_subtitle1" class="input">
                    <div class="input-note"></div>
                </div>
            </div>
