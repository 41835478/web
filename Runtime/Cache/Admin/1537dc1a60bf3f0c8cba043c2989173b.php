        ...
        <div class="table-responsive">
            <table class="table table-hover " id="table">
				...
				<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                        ...
                        <td>
                            <a title="生成静态" href="<?php echo U('edit',array('id'=>$k['class_id']));?>" class="button bg-blue button-small">生成静态</a>
                            <a title="修改" href="<?php echo U('edit',array('id'=>$v['class_id']));?>" class="button bg-blue button-small icon-pencil"></a>
                            <a title="删除" data="<?php echo ($v["class_id"]); ?>" url="/admin.php?r=article/AdminCategory/del" href="javascript:;" class="button bg-red button-small icon-trash-o js-del"></a>
                        </td>  
                        <td align="center"></td>
                        <td align="center"><?php echo ($v["sequence"]); ?></td>
                    </tr>
                    <?php if(is_array($v['class'])): foreach($v['class'] as $key=>$k): ?><tr>
                        <td align="center"><?php echo ($k["class_id"]); ?></td>                        
                        <td><a href="<?php echo U('news/index',array('id'=>$k['class_id']));?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─&nbsp;<?php echo ($k["name"]); ?></a></td>
                         <td>
                            <a title="生成静态" href="<?php echo U('edit',array('id'=>$k['class_id']));?>" class="button bg-blue button-small">生成静态</a>
                            <a title="修改" href="<?php echo U('edit',array('id'=>$k['class_id']));?>" class="button bg-blue button-small icon-pencil"></a>
                            <a title="删除" data="<?php echo ($k["class_id"]); ?>" url="<?php echo U('del');?>" href="javascript:;" class="button bg-red button-small icon-trash-o js-del"></a>
                        </td>
                        <td align="center"><?php echo (getArticleNum($k["class_id"])); ?></td>
                        <td align="center"><?php echo ($k["sequence"]); ?></td>
