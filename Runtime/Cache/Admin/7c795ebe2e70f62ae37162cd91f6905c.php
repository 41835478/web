        ...
        <table class="table table-hover " id="table">
            <tbody>
                ...
                <?php if(is_array($tag)): foreach($tag as $key=>$v): ?><tr>
                    <td>
                        <input type="checkbox" value="<?php echo ($v["tag_id"]); ?>" name="id[]">
                    </td>
                    <td><?php echo ($v["tag_id"]); ?></td>
                    <td><?php echo ($v["name"]); ?></td>
                    <td><?php echo ($v["url"]); ?></td>
                    <td>
                        <a title="修改" href="<?php echo U('edit',array('tag_id'=>$v['tag_id']));?>" class="button bg-blue button-small icon-pencil"></a>
                        <a title="删除" data="<?php echo ($v["tag_id"]); ?>" href="javascript:;" class="button bg-red button-small icon-trash-o js-del"></a>
                    </td>
