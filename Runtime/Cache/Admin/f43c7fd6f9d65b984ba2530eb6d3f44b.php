        ...
        <table class="table table-hover " id="table">
            <tbody>
                ...
                <?php if(is_array($news)): foreach($news as $key=>$v): ?><tr>
                    ...
                    <td align="center"><?php echo ($v["label"]); ?></td>
                    <td align="center"><?php echo ($v["width"]); ?></td>
                    <td align="center"><?php echo ($v["height"]); ?></td>
                    <td><?php echo (date('Y-m-d h:i:s',$v["ctime"])); ?></td>
                    <td>
                        <a title="预览" href="<?php echo ($v["url"]); ?>" target="_blank" class="button bg-blue button-small icon-eye"></a>
