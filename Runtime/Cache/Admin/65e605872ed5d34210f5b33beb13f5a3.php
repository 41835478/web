...
<div class="panel dux-box">
        ...
        <table id="table" class="table table-hover ">
            <tbody>
                <tr>
                    ...
                    <th width="*" align="left">邮箱</th>
                    <th width="*" align="left">手机</th>
                    <th width="*">添加时间</th>
                    <th width="70">状态</th>
                ...
                <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                    ...
                    <td align="center"><?php echo (date('Y-m-d',$v["ctime"])); ?></td>
                    <td align="center">
                        <?php if($v["status"] == 1): ?><span class="tag bg-green">已审核</span><?php endif; if($v["status"] == 0): ?><span class="tag bg-blue">被禁用</span><?php endif; ?>
                    </td>
                    <td align="center"><?php echo (date('Y-m-d',$v["last_login_time"])); ?></td>
                    <td align="center">
    ...
    <div class="panel-foot table-foot clearfix">
        ...
        <div class="float-rights"><?php echo ($pages); ?></div>
    </div>
</div>
<script>
