...
class LoginController extends AddonController{
    ...
    public function doregister(){
        ...
        $dates['mobile'] = $_POST['mobile'];
        $dates['username'] = $_POST['username'];
        $dates['password'] = md5($_POST['password']);
        $dates['avatar'] = $_POST['avatar'];
        $dates['group'] = 0;
        $dates['reg_ip'] = get_client_ip(1);
        $dates['ctime'] = NOW_TIME;
        $dates['utime'] = NOW_TIME;
        $dates['status'] = 1;
